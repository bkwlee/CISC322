...
public class TextEditor extends Application {
    ...
    private MenuDescriptor menu2;
    /* package */ MainPanel mainPanel;
    private static String title = "Simple PDF Editor";
    private static String copyright = "2017 David Alex Lamb & CISC 322 Group 5, Benjamin Lee, Rafael Rodriguez, Clark Hodgins";
